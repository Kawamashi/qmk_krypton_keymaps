...
- à détecter les séquences de frappes de caractères, pour inhiber certaines combos pendant celles-ci et pour paramétrer finement [Flow Tap](https://docs.qmk.fm/tap_hold#flow-tap)
