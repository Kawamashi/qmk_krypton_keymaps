...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_1DK] = LAYOUT_split_3x5_3(
      PG_X,    PG_VIRG, _______, _______, _______,                   _______, _______, _______, _______, _______,
    ...
    [_NUMBERS] = LAYOUT_split_3x5_3(
      ...
      PG_PERC, REV_TAB, ALT_TAB, OS_WNUM, PG_VIRG,                   PG_EXP,  KC_PDOT, KC_5,    PG_EURO, PG_DEG,
      ...
      PG_PERC, _______, KC_5,    KC_PDOT, PG_VIRG,                   PG_EXP,  _______, PG_DEG,  PG_EURO, OS_WNUM,
      P(KC_6), R(KC_7), M(KC_8), I(KC_9), PG_POIN,                   NUMWORD, I(KC_1), M(KC_2), R(KC_3), P(KC_4),
      PG_PLUS, PG_ASTX, PG_SLSH, PG_MOIN, TG_NUM,                    PG_IND,  KC_ENT,  _______, _______, OS_1DK,
      ...
      PG_PERC,    REV_TAB,    ALT_TAB,    OS_WNUM,    PG_VIRG,                   PG_EXP,  KC_7,    KC_8,    KC_9,    PG_EURO,
    ...
    [_SYMBOLS] = LAYOUT_split_3x5_3(
      ...
      // NNB_SPC finishes a numword (e.g. `127 km`) with reversed numrow.
      PG_PERC,    PG_INF,  PG_SUP,  PG_MOIN, PG_AROB,                  PG_ACIR, PG_LCBR, PG_RCBR, PG_DLR,  PG_GRV,
      PG_PLUS,    PG_ASTX, PG_SLSH, PG_EGAL, PG_POIN,                  PG_HASH, PG_LPRN, PG_RPRN, PG_PVIR, PG_DQUO,
      ALGR(PG_J), PG_TILD, PG_LSBR, PG_RSBR, PG_BSLS,                  _______, PG_2PTS, PG_ESPR, PG_PIPE, PG_APOD,
                                    OS_NUM,  KC_SPC,  KC_BSPC, _______, NNB_SPC, OS_RTHB
#endif
    ),
